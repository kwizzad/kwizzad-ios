...
class VirtualTimeScheduler<Converter: VirtualTimeConverterType>
    ...
    */
    ...
    /**
     ...
     - returns: The disposable object used to cancel the scheduled action (best effort).
     */
    func scheduleRelativeVirtual<StateType>(_ state: StateType, dueTime: VirtualTimeInterval, action: @escaping (StateType) -> Disposable) -> Disposable {
    ...
    /**
     ...
     - returns: The disposable object used to cancel the scheduled action (best effort).
     */
    func scheduleAbsoluteVirtual<StateType>(_ state: StateType, time: Converter.VirtualTimeUnit, action: @escaping (StateType) -> Disposable) -> Disposable {
    ...
    func adjustScheduledTime(_ time: Converter.VirtualTimeUnit) -> Converter.VirtualTimeUnit {
        return time
    }
