...
*/
final class ConcurrentMainScheduler : SchedulerType {
    ...
    static let instance = ConcurrentMainScheduler(mainScheduler: MainScheduler.instance)
    ...
    */
    ...
    - returns: The disposable object used to cancel the scheduled action (best effort).
    */
    final func scheduleRelative<StateType>(_ state: StateType, dueTime: Foundation.TimeInterval, action: @escaping (StateType) -> Disposable) -> Disposable {
