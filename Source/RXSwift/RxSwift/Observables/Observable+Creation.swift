...
extension Observable {
    ...
    */
    static func deferred(_ observableFactory: @escaping () throws -> Observable<E>)
        -> Observable<E> {
    ...
    */
    static func generate(initialState: E, condition: @escaping (E) throws -> Bool, scheduler: ImmediateSchedulerType = CurrentThreadScheduler.instance, iterate: @escaping (E) throws -> E) -> Observable<E> {
    ...
    */
    static func using<R: Disposable>(_ resourceFactory: @escaping () throws -> R, observableFactory: @escaping (R) throws -> Observable<E>) -> Observable<E> {
...
extension Observable {
     ...
     */
    static func from(_ optional: E?) -> Observable<E> {
    ...
    /**
     ...
     - returns: An observable sequence containing the wrapped value or not from given optional.
     */
    static func from(_ optional: E?, scheduler: ImmediateSchedulerType) -> Observable<E> {
