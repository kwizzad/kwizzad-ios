...
extension ObservableType {
    ...
    */
    func multicast<S: SubjectType>(_ subject: S)
    ...
    */
    func multicast<S: SubjectType, R>(_ subjectSelector: @escaping () throws -> S, selector: @escaping (Observable<S.E>) throws -> Observable<R>)
...
extension ObservableType {
    ...
    - returns: An observable sequence that contains the elements of a sequence produced by multicasting the source sequence.
    */
    func shareReplay(_ bufferSize: Int)
        -> Observable<E> {
        if bufferSize == 1 {
