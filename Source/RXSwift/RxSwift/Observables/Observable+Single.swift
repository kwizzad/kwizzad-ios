...
extension ObservableType {
    ...
    */
    func distinctUntilChanged<K: Equatable>(_ keySelector: @escaping (E) throws -> K)
        -> Observable<E> {
    ...
    */
    func distinctUntilChanged(_ comparer: @escaping (E, E) throws -> Bool)
        -> Observable<E> {
    ...
    */
    func distinctUntilChanged<K>(_ keySelector: @escaping (E) throws -> K, comparer: @escaping (K, K) throws -> Bool)
        -> Observable<E> {
...
extension ObservableType {
    ...
    */
    func scan<A>(_ seed: A, accumulator: @escaping (A, E) throws -> A)
        -> Observable<A> {
