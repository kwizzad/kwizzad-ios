...
extension ObservableType {
    ...
    */
    func filter(_ predicate: @escaping (E) throws -> Bool)
        -> Observable<E> {
...
extension ObservableType {
    ...
    */
    func takeWhile(_ predicate: @escaping (E) throws -> Bool)
        -> Observable<E> {
    ...
    - returns: An observable sequence that contains the elements from the input sequence that occur before the element at which the test no longer passes.
    */
    func takeWhileWithIndex(_ predicate: @escaping (E, Int) throws -> Bool)
        -> Observable<E> {
        return TakeWhile(source: asObservable(), predicate: predicate)
    }
}
...
extension ObservableType {
    ...
    */
    ...
    - returns: An observable sequence that contains the elements from the input sequence starting at the first element in the linear series that does not pass the test specified by predicate.
    */
    func skipWhileWithIndex(_ predicate: @escaping (E, Int) throws -> Bool) -> Observable<E> {
        return SkipWhile(source: asObservable(), predicate: predicate)
    }
}
...
extension ObservableType {
    ...
    */
    func map<R>(_ transform: @escaping (E) throws -> R)
        -> Observable<R> {
    ...
    - returns: An observable sequence whose elements are the result of invoking the transform function on each element of source.
    */
    func mapWithIndex<R>(_ selector: @escaping (E, Int) throws -> R)
        -> Observable<R> {
...
extension ObservableType {
    ...
    */
    ...
    - returns: An observable sequence whose elements are the result of invoking the one-to-many transform function on each element of the input sequence.
    */
    func flatMapWithIndex<O: ObservableConvertibleType>(_ selector: @escaping (E, Int) throws -> O)
        -> Observable<O.E> {
...
extension ObservableType {
    ...
    */
    func flatMapFirst<O: ObservableConvertibleType>(_ selector: @escaping (E) throws -> O)
        -> Observable<O.E> {
...
extension ObservableType {
    ...
    */
    ...
    - returns: An observable sequence that emits a single item or throws an exception if more (or none) of them are emitted.
    */
    func single(_ predicate: @escaping (E) throws -> Bool)
        -> Observable<E> {
