...
extension Observable {
     ...
     */
    static func combineLatest<C: Collection>(_ collection: C, _ resultSelector: @escaping ([C.Iterator.Element.E]) throws -> Element) -> Observable<Element>
...
extension Observable {
    /**
     ...
     - returns: An observable sequence containing the result of combining elements of the sources using the specified result selector function.
     */
    static func zip<C: Collection>(_ collection: C, _ resultSelector: @escaping ([C.Iterator.Element.E]) throws -> Element) -> Observable<Element>
    where C.Iterator.Element: ObservableType {
...
extension ObservableType {
    ...
    */
    func concat<O: ObservableConvertibleType>(_ second: O) -> Observable<E> where O.E == E {
...
extension Observable {
     ...
     */
    static func concat<S: Sequence >(_ sequence: S) -> Observable<Element>
    ...
    /**
     ...
     - returns: An observable sequence that contains the elements of each given sequence, in sequential order.
     */
    static func concat<S: Collection >(_ collection: S) -> Observable<Element>
        where S.Iterator.Element == Observable<Element> {
...
extension ObservableType {
    ...
    */
    func catchError(_ handler: @escaping (Swift.Error) throws -> Observable<E>)
        -> Observable<E> {
    ...
    */
    func catchErrorJustReturn(_ element: E)
        -> Observable<E> {
...
extension Observable {
     ...
     */
    static func catchError<S: Sequence>(_ sequence: S) -> Observable<Element>
        where S.Iterator.Element == Observable<Element> {
...
extension ObservableType {
    ...
    */
    func takeUntil<O: ObservableType>(_ other: O)
        -> Observable<E> {
...
extension ObservableType {
    ...
    */
    func skipUntil<O: ObservableType>(_ other: O)
        -> Observable<E> {
...
extension ObservableType {
    ...
    */
    func withLatestFrom<SecondO: ObservableConvertibleType, ResultType>(_ second: SecondO, resultSelector: @escaping (E, SecondO.E) throws -> ResultType) -> Observable<ResultType> {
    ...
    - returns: An observable sequence containing the result of combining each element of the self  with the latest element from the second source, if any, using the specified result selector function.
    */
    func withLatestFrom<SecondO: ObservableConvertibleType>(_ second: SecondO) -> Observable<SecondO.E> {
